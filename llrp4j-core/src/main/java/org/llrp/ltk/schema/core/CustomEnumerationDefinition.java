...
/**
 * <p>Java class for customEnumerationDefinition complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="customEnumerationDefinition">
 *   &lt;complexContent>
 ...
 *         &lt;element name="entry" type="{http://www.llrp.org/ltk/schema/core/encoding/binary/1.0}enumerationEntryDefinition" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "customEnumerationDefinition", propOrder = {
    "annotation",
    "entry"
})
public class CustomEnumerationDefinition {
    ...
    protected List<EnumerationEntryDefinition> entry;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EnumerationEntryDefinition }
     * 
     * 
     */
    public List<EnumerationEntryDefinition> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EnumerationEntryDefinition>();
        }
        return this.entry;
    }
