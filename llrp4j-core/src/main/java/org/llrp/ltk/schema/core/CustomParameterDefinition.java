...
/**
 * <p>Java class for customParameterDefinition complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="customParameterDefinition">
 *   &lt;complexContent>
 ...
 *           &lt;element name="allowedIn" type="{http://www.llrp.org/ltk/schema/core/encoding/binary/1.0}allowedInParameterReference"/>
 *         &lt;/sequence>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="subtype" use="required" type="{http://www.w3.org/2001/XMLSchema}unsignedInt" />
...
@XmlType(name = "customParameterDefinition", propOrder = {
    "annotation",
    "fieldOrReserved",
    "parameterOrChoice",
    "allowedIn"
...
public class CustomParameterDefinition {
    ...
    /**
     * Gets the value of the allowedIn property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the allowedIn property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAllowedIn().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AllowedInParameterReference }
     * 
     * 
     */
    public List<AllowedInParameterReference> getAllowedIn() {
        if (allowedIn == null) {
            allowedIn = new ArrayList<AllowedInParameterReference>();
        }
